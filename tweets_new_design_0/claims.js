...
export const claim3 = {
  dateAdded: "",
  claimText: "Palestinian society is pervasively evil",
  claimId: "000000003",
  incidentIds: [{ incidentId: "00000000Q"}]
}
...
const buttons = [
  ...
  // { category: "alAlhiHospitalBombing" }, // 4
  // { category: "alShifaHospital"}, // 4
  { category: "americanFundedViolence" }, // 
  { category: "antiIsraelJewsCounterarguments" },
  // { category: "antiIsraelProtestorTruthBombs" },
  // { category: "antiIsraelTwitterLies" }, // 4
  { category: "antiSemitism" },
  { category: "antiSemitismInversion" },
  // { category: "apartheid" }, // 4
  // { category: "blamingIsraelLies" }, // 4
  { category: "ceasefireGame" },
  // { category: "colonizersLie" }, // 4
  // { category: "campusProtests" }, 
  { category: "cryBullies" },
  // { category: "counteringAntiIsraelCliches" }, // 4
  { category: "dayAfterProtests" },
  // { category: "deathTollLie" }, // 4
  ...
  // { category: "gazanDoctorsAndJournalists" }, // 4
  // { category: "gazaSickCultureOfHate" }, // 5
  // { category: "gazaTeachesKidsHateAndViolence"}, // 5
  // { category: "genocideCliche" }, // 4
  // { category: "hamasInTheirOwnWordsAndHamasEvil" }, // 5
  // { category: "hamasLies" }, // 4
  { category: "hamasWarCrimes" }, // 5
  // { category: "harvestingOrgansLibel"}, // 4
  // { category: "heroicStories" },
  { category: "hideFacesLikeKlan" },
  // { category: "historyOfConflict" },
  // { category: "hostageStories" },
  // { category: "houthis" },
  // { category: "internationalLaw" }, // 2
  { category: "iransRole" },
